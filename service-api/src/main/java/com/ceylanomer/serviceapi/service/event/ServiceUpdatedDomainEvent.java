...
@NoArgsConstructor
@ToString
public class ServiceUpdatedDomainEvent extends ServiceDomainEvent {
    private List<Resource> resources;
    public ServiceUpdatedDomainEvent(ServiceAggregate service) {
        super(service, DomainEventType.SERVICE_UPDATED);
